...
import './step/the_user_sees_a_list_of_medicaments_with_respectively_information_with_paracetamol_in_name.dart';
...
void main() {
  group('''Medicament stock add/edit medicament''', () {
    ...
    testWidgets('''Access to the medicament database''', (tester) async {
      ...
      await theUserSeesAListOfMedicamentsWithRespectivelyInformationWithParacetamolInName(tester);
